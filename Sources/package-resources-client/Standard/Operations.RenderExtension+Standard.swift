...
extension PackageResourcesClient.Operations.RenderExtensions {
	public static func standard(
		renderAccessor: PackageResourcesClient.Operations.RenderResourceAccessor? = nil,
	...
	) -> PackageResourcesClient.Operations.RenderExtensions {
		...
		return .init { resources in
			Result {
				...
				return grouppedAccessors.compactMap { group in
					guard !group.accessors.isEmpty else { return nil }
					...
					if group.type == PackageResources.Font.typeName {
						...
						\(indent(1)("@available(*, deprecated, renamed: \"_customFonts\")"))
						\(indent(1)("public static var _spmgen: Self { _customFonts }"))
						
						\(indent(1)("public static var _customFonts: Self {["))
						\(fontAccessorsList)
						\(indent(1)("]}"))
						}
						""" + "\n\n"
